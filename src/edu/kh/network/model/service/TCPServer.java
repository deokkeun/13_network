...
public class TCPServer {
	...
	// ----> 서버 소켓과 클라이언트 소케싱 연결되어 데이터 통신이 가능해짐.
...
//		1. 서버의 포트번호 정함
		int port = 8500; // port 번호는 0~65535 사이 지정 가능
						// 단, 1023번 이하는 이미 사용주인 경우가 많으니 제외
		...
		//PrintWriter에는 println, print printf등 다양한 출력함수를 제공함으로써 파일 출력을 편하게 해준다.
